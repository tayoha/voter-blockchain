App = {
    ...
    loadContract: async () => {
      ...
      const registration = await $.getJSON('../build/Registration.json')
      App.contracts.Registration = TruffleContract(registration)
      App.contracts.Registration.setProvider(App.web3Provider)
  
      // Hydrate the smart contract with values from the blockchain
      App.Registration = await App.contracts.Registration.deployed()
    },
